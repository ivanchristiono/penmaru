...
<head>
  ...
  <title>Date&amp;time picker - Stack Responsive Bootstrap 4 Admin Template</title>
...
data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    ...
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="#"><i class="ft-zap"></i><span class="menu-title" data-i18n="">Starter kit</span><span class="badge badge badge-danger badge-pill float-right mr-2">New</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-1-column.html">1 column</a>
            </li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-2-columns.html">2 columns</a>
            </li>
            <li><a class="menu-item" href="#">Content Det. Sidebar</a>
              <ul class="menu-content">
                <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-content-detached-left-sidebar.html">Detached left sidebar</a>
                </li>
                <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-content-detached-left-sticky-sidebar.html">Detached sticky left sidebar</a>
                </li>
                <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-content-detached-right-sidebar.html">Detached right sidebar</a>
                </li>
                <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-content-detached-right-sticky-sidebar.html">Detached sticky right sidebar</a>
                </li>
              </ul>
            </li>
            <li class="navigation-divider"></li>
            ...
            <li class="navigation-divider"></li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-light.html">Light layout</a>
            </li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-dark.html">Dark layout</a>
            </li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-modern-menu-template/layout-semi-dark.html">Semi dark layout</a>
            </li>
          </ul>
        </li>
        <li class=" navigation-header">
        ...
        <li class=" nav-item"><a href="#"><i class="ft-box"></i><span class="menu-title" data-i18n="">Extra Components</span></a>
          <ul class="menu-content">
            ...
            <li class="active"><a class="menu-item" href="ex-component-date-time-picker.html">DateTime Picker</a>
            </li>
    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title mb-0">Date&amp;time picker</h3>
        ...
        <section id="datetime">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Bootstrap DateTime Picker</h4>
                  ...
                  <div class="row">
                    <div class="col-md-6 col-sm-6 col-12">
                      <div class="form-group">
                        <label>No Icon (input field only) Date &amp; Time Picker</label>
                      ...
                      <div class="form-group">
                        <label>Date &amp; Time Picker With French Language</label>
                      ...
                      <div class="form-group">
                        <label>Linked Date &amp; Time Picker</label>
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                      ...
                      <div class="form-group">
                        <label>Calendar Minimum View Mode</label>
  ...
  <script src="../../../app-assets/vendors/js/pickers/dateTime/bootstrap-datetimepicker.min.js"
  type="text/javascript"></script>
  ...
  <!-- END STACK JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  <script src="../../../app-assets/js/scripts/pickers/dateTime/bootstrap-datetime.js"
  type="text/javascript"></script>
