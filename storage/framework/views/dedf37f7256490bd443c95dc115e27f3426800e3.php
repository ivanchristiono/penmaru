...
<head>
  ...
  <link href="<?php echo e(asset('app-assets/css/vendors.css')); ?>" rel= "stylesheet" type="text/css">
  <link href="<?php echo e(asset('css/jquery.dataTables.css')); ?>" rel="stylesheet" type="text/css">
  <link href="<?php echo e(asset('app-assets/vendors/css/tables/datatable/datatables.min.css')); ?>" rel="stylesheet" type="text/css">
...
<?php endif; ?>
      ...
      <script src="<?php echo e(asset('app-assets/vendors/js/pickers/dateTime/bootstrap-datetimepicker.min.js')); ?>" type="text/javascript"></script>
      ...
      <script src="<?php echo e(asset('app-assets/js/scripts/pickers/dateTime/bootstrap-datetime.js')); ?>" type="text/javascript"></script>
      <script src="<?php echo e(asset('app-assets/js/scripts/pickers/dateTime/pick-a-datetime.js')); ?>" type="text/javascript"></script>
      <!-- END PAGE LEVEL JS-->
